...
public class BankCodeTimeCount extends CountDownTimer {

    private SpannableString msp = null;
    private int timeNum = 60;
    private BankCodeDialog activity;
    ...
    public BankCodeDialog getActivity() {
        return activity;
    }

    public void setActivity(BankCodeDialog activity) {
        this.activity = activity;
    }

    public BankCodeTimeCount(long millisInFuture, long countDownInterval) {
